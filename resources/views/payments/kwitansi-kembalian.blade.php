    ...
    <section class="sheet">
        ...
        <div class="container">
            ...
            >
                ...
                <h5 class="text-center text-danger mb-3">Kwitansi Pengembalian Dana (Koperasi)</h5>
                <div class="col">
            ...
            <div class="row">
                ...
                >
                    ...
                    Telah dikembalikan sejumlah : <b>Rp{{ number_format(abs($payment->nominal), 0, ',', '.') }},-</b>.
                    yang terbilang : <b>{{ ucwords(terbilang(abs($payment->nominal))) }} Rupiah.</b>
                    <br>Pengembalian dana ini adalah pengembalian sebagian biaya pendaftaran peserta didik. Kwitansi ini sebagai bukti pengembalian dana
                    peserta didik Tahun Ajaran {{ \Carbon\Carbon::parse($payment->tanggal_bayar)->format('Y') }} /
    ...
    <section class="sheet">
        ...
        <div class="container">
            ...
            >
                ...
                <h5 class="text-center text-danger mb-3">Kwitansi Pengembalian Dana (Siswa)</h5>
                <div class="col">
    ...
    <section class="sheet">
        ...
        <div class="container">
            ...
            >
                ...
                <h5 class="text-center text-danger mb-3">Kwitansi Pengembalian Dana (Bendahara)</h5>
                <div class="col">
