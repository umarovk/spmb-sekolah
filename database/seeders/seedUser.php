...
class seedUser extends Seeder
{
    public function run(): void
    {
        DB::table('users')->insert([
            ...
            ['username' => 'dhani', 'nama' => 'Dhani Dwi Wijayanto, S.Pd', 'email' => 'dhaninto_wijaya@yahoo.com', 'password' => bcrypt ('guru12345'), 'role' => 'selektor'],
            ...
            ['username' => 'cahyaning', 'nama' => 'Cahyaning Dyah Respati, S.Pd', 'email' => 'shakiraalta@gmail.com', 'password' => bcrypt ('admin123'), 'role' => 'admin'],
            ['username' => 'yuniah', 'nama' => 'Yuniah Eka Rachmani, S.Pd.I', 'email' => 'yuniaheka88@gmail.com', 'password' => bcrypt ('guru12345'), 'role' => 'selektor'],
            ...
            ['username' => 'suswan', 'nama' => 'Suswan, S.Pd', 'email' => 'suswanuny@gmail.com', 'password' => bcrypt ('admin123'), 'role' => 'admin'],
            ['username' => 'abdurrohman', 'nama' => 'Abdurrohman H, S.Kom.', 'email' => 'habdurrohman9@gmail.com', 'password' => bcrypt ('guru12345'), 'role' => 'guest'],
            ['username' => 'guruh', 'nama' => 'Guruh Susi Pangestuti, S.Pd.', 'email' => 'guruhgilar@gmail.com', 'password' => bcrypt ('guru12345'), 'role' => 'selektor'],
