...
class Siswa extends Model
{
    ...
    protected $fillable = [
        'namasiswa', 'jurusan', 'jeniskelamin', 'agama', 'tempatlahir', 'tanggallahir', 'tahun_lulus_smp',
        ...
        'jenis_tinggal', 'jumlah_saudara', 'anak_ke', 'cita_cita', 'hobi', 'nama_ayah', 'pendidikan_ayah',
